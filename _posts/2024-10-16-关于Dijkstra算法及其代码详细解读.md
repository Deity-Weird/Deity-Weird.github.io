...
<p align = "center"><img  src="image-13.png" width="500" /></p>

###### &emsp;&emsp;此时最短路径0→1→3→4，最短距离为17
<p align = "center"><img  src="image-25.png" width="400" /></p>
<p align = "center"><img  src="image-14.png" width="500" /></p>

###### &emsp;&emsp;上一步最短路径0→1→3→4，最短距离为17，则：
###### &emsp;&emsp;0→1→3→4→5的距离为23>22：不更新表格
###### &emsp;&emsp;0→1→3→4→6的距离为19<∞：更新表格
<p align = "center"><img  src="image-26.png" width="400" /></p>
<p align = "center"><img  src="image-15.png" width="500" /></p>

###### &emsp;&emsp;此时最短路径0→1→3→4→6，最短距离为19
<p align = "center"><img  src="image-27.png" width="400" /></p>
<p align = "center"><img  src="image-16.png" width="500" /></p>
